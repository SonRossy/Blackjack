...
import static com.blackjack.BlackJack.MENU_LAYER;
import static com.blackjack.BlackJack.PRIMARY_VIEW;
import static com.blackjack.BlackJack.SECONDARY_VIEW;
...
public class DrawerManager {
    ...
    public DrawerManager() {
        ...
        NavigationDrawer.Header header = new NavigationDrawer.Header("Gluon Mobile",
                "Multi View Project",
                new Avatar(21, new Image(DrawerManager.class.getResourceAsStream("/CardOne_1.png"))));
